...
<form>
  <div class="row">
    <div class="six columns">
      ...
      <input class="u-full-width" type="text" placeholder="Company Name" id="compnaneInput">
    </div>
    <div class="six columns">
      <label for="countryInput">County</label>
  ...
  <div class="row">
    <div class="six columns">
      ...
      <input class="u-full-width" type="text" placeholder="City Name" id="citynameInput">
    </div>
    <div class="six columns">
      <label for="countryInput">Size</label>
      <select class="u-full-width" id="countryInput">
      <option value="" disabled="disabled" selected="selected">Select the Company Size (No. of employees)</option>
        ...
        <option value="Option 2">6-10</option>
  ...
  <div class="row">
    <div class="six columns">
      ...
      <input class="u-full-width" type="text" placeholder="Website" id="websiteInput">
    </div>
    <div class="six columns">
      <label for="countryInput">Industry</label>
      <select class="u-full-width" id="countryInput">
      <option value="" disabled="disabled" selected="selected">Select the Company Industry</option>
        <option value="Option 1">Accounting and Auditing Services</option>
        <option value="Option 2">Advertising and Public Relations</option>
        <option value="Option 3">Agriculture / Forestry / Fishing</option>
      </select>
    </div>
  </div>
  <label for="aboutus">About Us</label>
  <textarea class="u-full-width" placeholder="About Us" id="aboutus"></textarea>
