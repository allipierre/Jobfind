...
//	@Query(value = "SELECT id,name,website,about,city,location,industry,numbere FROM Company t", nativeQuery = true)
	...
	@Query(value = "Select id,name,namens,website,about,city,location,industry_id,numbere from Company a  inner join Industry b on a.industry_id=b.ides;", nativeQuery = true)
